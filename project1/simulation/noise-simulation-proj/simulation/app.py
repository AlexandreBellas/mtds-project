from simulation.initialization.load_regions import loadCountry
from simulation.initialization.spawn_entities import spawn_people_and_vehicles
...
polygon_bounding_box = Polygon(
    [(1290773.81, 1421304.01), (1292065.26, 1421613.65), (1292294.97, 1420691.03), (1290811.45, 1420198.23)])
